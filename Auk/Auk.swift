...
public class Auk {
    ...
    */
    ...
    /**
     ...
     Shows a local image with description and sub-description in the scroll view.
     
     - parameter image: Image to be shown in the scroll view.
     - parameter description: Description to be shown in the scroll view.
     - parameter subDescription: Sub-Description to be shown in the scroll view.
     - parameter accessibilityLabel: Text describing the image that will be spoken in accessibility mode. For example: "Picture of a pony standing in a flower pot.".
     
     */
    public func show(image image: UIImage, description: String, subDescription: String, promotion: String, accessibilityLabel: String? = nil) {
        setup()
        let page = createPage(accessibilityLabel)
        page.show(image: image, description: description, subDescription: subDescription, promotion: promotion, settings: settings)
    }
